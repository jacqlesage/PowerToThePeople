 ...
 */
public class BizLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(BizLoginActivity.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(emailOrNoEmail){
               ...
               changeToSignUpView(mEmail.toString());
    ...
    private void changeToSignUpView(String email) {
    System.out.println(email + " ****@**@#@(");
        //else we divert them to signing up page for business
        Intent intent = new Intent(this, BizSignUpActivity.class);
